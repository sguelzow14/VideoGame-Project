...
listpage<-str_c("https://www.metacritic.com/browse/games/score/metascore/all/ps4/filtered?sort=desc&page=",a)
...
TOPPS4<-readRDS(file="TOPPS4")
All<-bind_rows(my_data, .id = "column_label")
All<- All%>%
  select(-column_label)
AllTitle<-rbind(All,TOPPS4)
